      ...
      <div className="container footer-inner">
        ...
        <div className="footer-brand-col">
          ...
          <p className="footer-tagline">
            A place for curious minds to write,<br />share, and discover ideas.
          </p>
        ...
        <div className="footer-links-col">
          ...
          <ul className="footer-link-list">
            <li><a href="#posts">Read Posts</a></li>
            <li><a href="#posts">Start Writing</a></li>
            <li><a href="mailto:hello@blogspace.io">Contact</a></li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        <div className="container footer-bottom-inner">
          <p className="footer-copy">
            © {year} <span>BlogSpace</span>. Crafted with care.
          </p>
        </div>
      </div>
    </footer>
